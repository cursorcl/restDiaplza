# coding: utf-8
from sqlalchemy import BigInteger, Column, DateTime, Float, Index, Integer, LargeBinary, MetaData, Numeric, SmallInteger, String, TEXT, Table, text
...
t_CTADOCTO = Table(
    ...
    Column('TBank', BIT, server_default=text("((0))")),
...
t_EOS_CONFIGURACION = Table(
    ...
    Column('clave', String(255, 'Modern_Spanish_CI_AS'), primary_key=True),
    Column('valor', TEXT(2147483647, 'Modern_Spanish_CI_AS'))
)
...
t_EOS_LOGVENTAS = Table(
    ...
    Column('fecha', DateTime),
    Column('vendedor', String(50, 'Modern_Spanish_CI_AS')),
    Column('tipo', String(50, 'Modern_Spanish_CI_AS')),
    Column('titulo', String(50, 'Modern_Spanish_CI_AS')),
    Column('mensaje', String(collation='Modern_Spanish_CI_AS')),
    Column('json_parameters', TEXT(2147483647, 'Modern_Spanish_CI_AS'))
)
